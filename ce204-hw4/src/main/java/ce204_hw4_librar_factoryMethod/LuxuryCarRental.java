...
public class LuxuryCarRental implements ICarRental{
    ...
    private int price;
    /**
     * Constructs a LuxuryCarRental object with the specified details.
     * 
     ...
     */
    public LuxuryCarRental(int mileage, String brand, String model, int year, String fuelType, String gear, String color, int price) {
	...
	public void rentCar() {
		...
		System.out.println("Brand: " + brand + ", Model: " + model + ", Year: " + year +
                ", Fuel Type: " + fuelType + ", Gear: " + gear + ", Color: " + color +
