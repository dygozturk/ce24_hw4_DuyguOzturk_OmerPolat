...
public class EconomyCarRental implements ICarRental{
    ...
    private int price;
    /**
     * Constructs an EconomyCarRental object with the specified details.
     * 
     ...
     */
    public EconomyCarRental(int mileage, String brand, String model, int year, String fuelType, String gear, String color, int price) {
     ...
     * 
     * @return the gear type of the car
     */
	@Override
